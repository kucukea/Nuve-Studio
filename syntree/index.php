...
<?php
    ...
    if($_GET["i"])
    $code_textarea = $_GET["i"];
    ?>

<div id="accordion">
<h3><a href="#">Syntax Tree Generator</a></h3><div style="text-align:left">
<?php echo '<textarea id="i" rows="4">'.$code_textarea.'</textarea>'; ?>
 This project modified by Nuve Development Team and (C) 2011 by <a href="http://mshang.ca/">Miles Shang</a>, see <a href="LICENSE.txt">license</a>.
</div>
